...
//...brak ciągłych operacji na DOM, przy kolejnej operacji na każdym z nowo dostawianych z osobna elementów lub ich modyfikowaniu (np. atrybuty, itp.)
    ...
    fragment
        .append('<h2>OopS!</h2>')
        .append('<p class="error">Nie ma takiego adresu! To się miało nigdy nie zdarzyć, ale jednak niemożliwe staje się osiągalne.<br /><strong>Użytkowniku</strong>: <em>nie kobinuj! Zweryfikuj wprowadzony adres lub korzystaj tylko z wyświetlonych odnośników i przycisków!</em></p>');
